...
const countries = [
  ...
  { name: "Malawi", region: "Africa", status: "Upcoming", effectiveDate: "May 2026", mandateType: "B2B + B2G + B2C", model: "Clearance", format: "XML / JSON", platform: "MRA EIS", penalties: "Non-EIS invoices invalid for VAT purposes after May 2026", summary: "MRA Electronic Invoicing System (EIS) replaces legacy Electronic Fiscal Devices (EFDs). Pilot extended to Apr 30, 2026; mandatory for all VAT-registered businesses from May 1, 2026. Real-time invoice validation by MRA. VAT (EIS) Regulations 2026 published Jan 9. EFD-generated invoices no longer accepted for input VAT claims after transition." },
      ...
      {expanded && (
        <div style={{ padding: "12px 20px 20px" }}>
          ...
          <div style={{ marginTop: 10, fontSize: 11, color: "#94a3b8", textAlign: "right" }}>
            Showing {filtered.length} of {recentChanges.length} changes · Mar 2 – Apr 24, 2026
          </div>
        </div>
      )}
    </div>
