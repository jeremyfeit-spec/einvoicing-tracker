...
const countries = [
  ...
  { name: "Belgium", region: "Europe", status: "Live", effectiveDate: "Jan 2026", mandateType: "B2B + B2G", model: "Post-Audit", format: "Peppol UBL 2.1", platform: "Peppol Network", penalties: "Penalties active from April 2026 for non-compliance", summary: "Mandatory B2B e-invoicing since Jan 1, 2026 via Peppol. Grace period ended Apr 2026 — penalties now enforced. Over 1M Peppol recipients nationwide." },
  ...
  { name: "Greece", region: "Europe", status: "Live", effectiveDate: "2020", mandateType: "B2B + B2G", model: "Clearance", format: "myDATA XML", platform: "myDATA / AADE", penalties: "Fines up to €2,500 per violation", summary: "Mandatory real-time reporting via myDATA. B2B and B2G transactions must be reported to AADE." },
  ...
  { name: "Latvia", region: "Europe", status: "Live", effectiveDate: "2025", mandateType: "B2B + B2G", model: "Post-Audit", format: "Peppol BIS / EN 16931", platform: "SRS Portal", penalties: "Administrative fines for non-compliance", summary: "Mandatory B2B e-invoicing commenced 2025. All businesses must submit e-invoice data to SRS and receive structured e-invoices." },
  ...
  { name: "Malaysia", region: "Asia-Pacific", status: "Live", effectiveDate: "Aug 2024", mandateType: "B2B + B2G + B2C", model: "Clearance", format: "XML / JSON", platform: "MyInvois (LHDN)", penalties: "Fines and penalties per Malaysian tax law", summary: "Phased rollout by revenue threshold. MyInvois portal FAQs updated Mar 9, 2026." },
