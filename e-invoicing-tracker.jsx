...
const countries = [
  ...
  { name: "UAE", region: "Middle East", status: "Upcoming", effectiveDate: "Jul 2026", mandateType: "B2B + B2G", model: "Clearance", format: "PINT-AE (UBL 2.1 XML)", platform: "FTA Portal / Accredited Service Providers (Peppol)", penalties: "Up to AED 50,000; administrative penalties reduced by FTA effective Apr 14, 2026", summary: "Voluntary pilot starting Jul 2026. Large businesses (≥AED 50M) mandatory from Jan 1, 2027; <AED 50M from Jul 1, 2027; Government entities Oct 1, 2027. Five-corner Peppol model via accredited Access Point Service Providers. 24-month grace period for intra-VAT group transactions (exempt until Jan 2029). B2C and simplified invoices <AED 10K excluded. FTA reduced several administrative tax penalties effective Apr 14, 2026 to ease compliance burden. 50+ mandatory data elements; 14-day transmission deadline; records must be stored in UAE." },
  ...
  { name: "Brazil", region: "Latin America", status: "Live", effectiveDate: "2008", mandateType: "B2B + B2G + B2C", model: "Clearance", format: "XML", platform: "NF-e / NFS-e / NFC-e / CT-e (SEFAZ)", penalties: "Fines and operational restrictions", summary: "Pioneer in e-invoicing. NF-e for goods, NFS-e for services, CT-e for transport. All cleared through SEFAZ. PIS/COFINS invoicing rules updated under Complementary Law 224/2025 (effective Apr 1, 2026): previously zero-rated transactions now taxed at 10% of normal rate — businesses must use CST code 06 in NF-e and reference Complementary Law 224/2025 in additional tax information (tax credits retained). SINIEF Adjustments 10–13/2026 add flexibility: retailers choose between NF-e and NFC-e; DANFE Type 2 (Simplified Non-fiscal Receipt) rollout Aug 3, 2026; NF-e references to NFC-e restricted from Oct 5, 2026; enhanced offline contingency." },
  ...
  { name: "Dominican Republic", region: "Latin America", status: "Partially Live", effectiveDate: "May 2026", mandateType: "B2B + B2G + B2C", model: "Clearance", format: "XML (e-CF)", platform: "DGII (e-CF)", penalties: "Fines per DGII regulations; non-compliant invoices invalid for tax purposes after Phase 3 deadline", summary: "e-CF (Comprobante Fiscal Electrónico) system under Law No. 32-23. Phased rollout: Phase 1 National Large Taxpayers (deadline May 15, 2024 — complete); Phase 2 Local Large + Medium Taxpayers (deadline extended to Nov 15, 2025 — complete); Phase 3 Small, Micro, Unclassified Taxpayers and state entities (deadline May 15, 2026). After May 15, 2026, e-CF becomes only valid invoicing method nationwide. DGII updated e-CF Technical Report v1.0 in 2026 with updated technical requirements." },
