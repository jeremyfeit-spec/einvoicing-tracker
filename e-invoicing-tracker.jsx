...
const recentChanges = [
  // May 2026
  { date: "May 19", country: "UAE", type: "Update", change: "FTA extended the deadline for large businesses to appoint an Accredited Service Provider (ASP) for e-invoicing to October 30, 2026 (from original July 1, 2026 pilot date). The mandatory go-live date of January 1, 2027 for large businesses (≥AED 50M) remains unchanged. FTA clarified this is not a mandate delay but an opportunity for businesses to select an ASP more carefully. The 5-corner model (Corner 5 tax reporting) and July 1, 2026 voluntary pilot remain in place.", source: "https://www.vatupdate.com/2026/05/14/uae-extends-asp-appointment-deadline-for-large-businesses-under-e-invoicing-to-october-2026/" },
  { date: "May 19", country: "France", type: "Update", change: "France External Specifications v3.2 published May 16, 2026 — provides updated technical requirements for businesses, Plateformes Agréées (PA), and system providers ahead of the Sep 1, 2026 B2B e-invoicing mandate. Key changes include mandatory hourly batching for PDP submissions to the PPF (individual submissions no longer accepted), new sector-specific use cases for agriculture and food industries, and postponement of VAT return pre-filling based on PPF data until 2029. AFNOR also published guidance FD Z42-029 on electronic invoice archiving requirements under the 2026 reform.", source: "https://www.vatupdate.com/2026/05/16/france-external-specifications-v3-2-key-technical-updates-ahead-of-the-2026-e-invoicing-mandate/" },
  { date: "May 19", country: "Germany", type: "Update", change: "BMF clarified (May 14, 2026): from January 2027, e-invoices delivered by email must be in a valid structured XML format (XRechnung or ZUGFeRD). Email delivery of non-XML hybrid formats or PDF-only invoices will not be considered compliant structured e-invoices for B2B issuance purposes. Applies to all businesses subject to the Jan 2027 mandatory issuance requirement for turnover >€800K.", source: "https://www.vatupdate.com/2026/05/14/e-invoices-in-germany-email-delivery-allowed-only-in-valid-xml-formats-from-2027/" },
  { date: "May 19", country: "Peru", type: "Update", change: "SUNAT accelerating e-invoicing rollout to bring more taxpayers into the CPE system in 2026, while simultaneously extending penalty-free relief under the SIRE (Sistema Integrado de Registros Electrónicos) electronic records framework. Businesses transitioning to digital reporting obligations benefit from extended grace period before enforcement applies.", source: "https://www.vatupdate.com/2026/05/15/peru-accelerates-e-invoicing-rollout-and-extends-penalty-relief-under-sire-framework/" },
  { date: "May 19", country: "Finland", type: "Update", change: "Finnish Tax Administration began sending e-invoice proposals to approximately 400,000 taxpayers in May 2026 as part of its pre-filled VAT return digitalization initiative. Businesses receiving proposals should review and confirm or correct the data. This is part of Finland's broader digital tax compliance infrastructure ahead of ViDA 2030.", source: "https://www.vatupdate.com/2026/05/05/400000-taxpayers-to-receive-e-invoice-proposals-from-tax-administration-in-may-2026/" },
  { date: "May 19", country: "Turkey", type: "Update", change: "Turkish Revenue Administration (GIB) requires e-document integration in next-generation payment devices (OKC NG) from May 2026. New POS/payment terminals must have built-in capability to generate and transmit e-documents (e-receipt, e-archive invoice) directly from the device without separate software. Affects manufacturers and businesses deploying new payment hardware.", source: "https://www.vatupdate.com/2026/05/14/turkey-requires-e-document-integration-in-next-gen-payment-devices-from-may-2026/" },
  { date: "May 15", country: "Belgium", type: "Update", change: "Belgium considering extending mandatory B2B e-invoicing scope to non-resident (non-established) businesses with only Belgian VAT registration by January 1, 2028, coinciding with start of mandatory near real-time e-reporting. Currently non-established businesses are excluded from the Jan 2026 mandate but may use e-invoicing voluntarily. Discussion stage; no final decision yet. Would require full Peppol capability, determination logic, and reporting alignment for foreign VAT registrants.", source: "https://www.vatupdate.com/2026/05/14/belgium-may-extend-e-invoicing-mandate-to-non-resident-vat-holders-by-2028/" },
  { date: "May 15", country: "EU (ViDA)", type: "Milestone", change: "Updated EN 16931 e-invoicing standard expected to be formally published by May 2026, serving as reference standard for the ViDA 2030 Digital Reporting Requirements (DRR) mandate. CEN approved revision on Feb 13, 2026 — adds new data fields specifically for B2B/DRR reporting: IBAN, corrective invoice numbering, early payment discounts, FX data, and broader range of VAT scheme codes. Member States gain flexibility to use alternative standards for domestic mandates while staying compatible with EU framework. Second draft explanatory notes in progress through early 2027.", source: "https://www.vatcalc.com/eu/eu-updates-en-16931-e-invoicing-standard-for-vida/" },
  { date: "May 12", country: "Dominican Republic", type: "Status", change: "Status revised: Live → Partially Live. DGII extended Phase 3 e-invoicing compliance deadline for small, micro, and unclassified taxpayers by six months to November 15, 2026 (previously May 15, 2026). Extension is automatic — no application required. Sanctions under Law No. 32-23 will apply from November 15, 2026. Phases 1 and 2 (large and medium taxpayers) remain fully live.", source: "https://www.vatupdate.com/2026/05/09/dominican-republic-extends-e-invoicing-deadline-for-small-micro-and-unclassified-taxpayers-to-november-2026/" },
  { date: "May 12", country: "Sri Lanka", type: "Status", change: "Status upgraded: Upcoming → Partially Live. IRD launched National e-Invoicing System for VAT under 2026 Budget. Phase 1 (export-oriented VAT-registered enterprises — garment, tea exporters) live from May 1, 2026 via Web API integration with IRD's RAMIS platform. Tea brokers already integrated. New mandatory VAT invoice format takes effect July 2026. Full rollout (Phase 2: all VAT-registered persons) by end of 2026.", source: "https://www.vatupdate.com/2026/05/09/sri-lanka-launches-national-e-invoicing-system-for-vat-under-2026-budget-full-rollout-by-year-end/" },
  { date: "May 12", country: "Romania", type: "Update", change: "Mandatory e-invoice registration expanded to non-profits, farmers, and individuals with new deadlines (May 9, 2026). Further broadens scope beyond PFAs (sole traders) covered in earlier extension. e-VAT enforcement continues to tighten under GEO 13/2026.", source: "https://www.vatupdate.com/2026/05/09/romania-expands-mandatory-e-invoice-registration-to-non-profits-farmers-and-individuals-with-new-deadlines/" },
  { date: "May 12", country: "Namibia", type: "Update", change: "Phased three-year rollout confirmed: mandatory e-invoicing delayed from April 2026 single launch to a graduated 2026/27–2028/29 implementation. Phase timing by taxpayer category to be announced. Infrastructure development and stakeholder alignment cited as reasons. Government remains committed to VAT Act modernization and fraud reduction via e-invoicing.", source: "https://www.vatupdate.com/2026/05/06/namibia-delays-mandatory-e-invoicing-adopts-phased-rollout-over-three-years/" },
  { date: "May 12", country: "Greece", type: "Update", change: "myDATA e-Delivery Phase B delayed: full digital goods-movement tracking (e-transport) Phase B now starts October 12, 2026 (previously earlier in 2026). Control data activation set for Oct 12, 2026; TARIC-aligned commodity coding mandatory from January 1, 2027. Core B2B e-invoicing deadlines unchanged (large taxpayers live, all others Oct 1, 2026).", source: "https://www.vatupdate.com/2026/05/09/greece-delays-mydata-e-delivery-phase-two-full-digital-tracking-now-starts-october-2026/" },
  { date: "May 12", country: "Turkey", type: "Update", change: "Mandatory e-Beyan system for VAT returns (electronic declaration) expanded to additional provinces from May 2026. Broadens the geographic scope of Turkey's digital tax reporting obligations.", source: "https://www.vatupdate.com/2026/05/09/turkey-expands-mandatory-e-beyan-system-for-vat-returns-to-more-provinces-from-may-2026/" },
  { date: "May 8", country: "Qatar", type: "New", change: "Added to tracker. Qatar Cabinet approved a draft e-invoicing law and implementing regulations on May 6, 2026, establishing a legal framework for electronic invoices and credit notes. Developed by the Ministry of Finance and General Tax Authority. Model expected to resemble Saudi Arabia's FATOORA — clearance for B2B/B2G, reporting for B2C. Likely phased implementation starting Jan 1, 2027. No confirmed timeline, technical specifications, or VAT regime alignment announced yet. Businesses advised to begin evaluating system impact.", source: "https://www.vatupdate.com/2026/05/08/qatar-approves-draft-e-invoicing-law/" },
  { date: "May 8", country: "Germany", type: "Update", change: "BMF March 23, 2026 FAQ update (widely covered May 7–8): all e-invoice references must be self-contained. If an invoice references a contract, timesheet, or delivery note, that document must be physically embedded in the e-invoice file — external links or text references alone are no longer compliant. Applies to both XRechnung (XML) and ZUGFeRD formats. Credit notes must also be structured e-invoices referencing original invoice in XML. Aligns with §14 UStG and EN 16931; prepares market for 2027 mandatory B2B issuance.", source: "https://www.vatupdate.com/2026/05/07/germanys-march-2026-e-invoice-faq-update-all-references-must-be-self-contained-in-the-e-invoice/" },
  { date: "May 7", country: "Slovakia", type: "Milestone", change: "Slovakia issues further guidance on e-invoicing and e-reporting obligations (May 7): clarifies rules for non-VAT payers, VAT-exempt transactions, EDI usage, archiving, and handling of incorrect invoices. Financial Administration announced conference on mandatory e-invoicing in Bratislava on May 26, 2026 to prepare businesses ahead of Jan 1, 2027 mandatory launch. Voluntary e-invoicing officially live since May 1, 2026 — XML structured invoices exchanged via IS EFA/Peppol are now valid tax documents.", source: "https://www.vatupdate.com/2026/05/07/slovakia-issues-further-guidance-on-e-invoicing-and-e-reporting-obligations/" },
  { date: "May 6", country: "Slovakia", type: "Milestone", change: "Financial Administration launched interactive e-invoicing guide for businesses and entrepreneurs to assist preparation ahead of mandatory Jan 1, 2027 rollout. Guide covers IS EFA platform, certified Digital Postmen service providers, and structured XML (EN 16931/Peppol) requirements.", source: "https://www.vatupdate.com/2026/05/06/financial-administration-launches-interactive-guide-for-e-invoicing-to-help-businesses-prepare/" },
  { date: "May 7", country: "Kenya", type: "Milestone", change: "KRA begins pre-filling VAT returns with validated import/export data from the Integrated Customs Management System (iCMS) starting May 2026. Validated export values automatically pre-filled in VAT returns once export documents are issued by Customs. Exporters and clearing agents must now capture exporter PIN and a valid eTIMS zero-rated invoice number in iCMS for accurate pre-filling. Applies to exports to Single Customs Territory, foreign countries, EPZs, and SEZs.", source: "https://www.vatupdate.com/2026/04/29/kenya-to-pre-fill-vat-returns-with-customs-data-starting-may-2026/" },
  { date: "May 7", country: "Denmark", type: "Update", change: "OIOUBL 2.1 Schematron v1.17.1 implementation date adjusted to May 18, 2026 (minor delay from May 15). Introduces stricter tax code consistency checks, enhanced Peppol VAT code alignment, and mandatory currency validation on amount fields. Rule F-LIB404 affected ~5% of invoices, prompting extended implementation period. OIOUBL 2.1 remains in use until Jul 2029 when Nemhandel BIS 4 migration completes.", source: "https://sapeinvoice.com/denmark-oioubl-21-schematron-1170-rc/" },
...
const countries = [
  ...
  { name: "Finland", region: "Europe", status: "Partially Live", effectiveDate: "Apr 2020", mandateType: "B2G", model: "Post-Audit", format: "Peppol BIS / Finvoice", platform: "Peppol / Banking Networks", penalties: "Rejection of non-compliant B2G invoices", summary: "B2G mandatory since Apr 2020 via Peppol. Strong voluntary B2B adoption through Finvoice and banking networks. In May 2026, the Finnish Tax Administration began sending e-invoice proposals to approximately 400,000 taxpayers as part of its pre-filled VAT return digitalization initiative — businesses receiving proposals should review and confirm or correct the data." },
  { name: "France", region: "Europe", status: "Upcoming", effectiveDate: "Sep 2026", mandateType: "B2B + B2G", model: "Clearance", format: "Factur-X / UBL / CII", platform: "PPF + Plateformes Agréées (PA)", penalties: "€15 per non-compliant invoice (capped at €15,000/year)", summary: "Mandatory B2B e-invoicing from Sep 1, 2026 (large/mid-size companies issue + all receive). SMEs must issue by Sep 2027. Pilot running Feb–Aug 2026 with 10,400+ issuers, 15,100+ receivers, and 112 Approved Platforms engaged. Architecture: PPF acts only as central directory and tax data hub; all invoice exchange via accredited Plateformes Agréées (PA). DGFIP announced intent to become France's Peppol Authority. External Specifications v3.2 published May 16, 2026 — mandates hourly batching for PA submissions to PPF (no more individual invoice submissions), adds new agriculture/food sector use cases, and confirms VAT return pre-filling from PPF data is postponed to 2029. AFNOR published FD Z42-029 archiving guidance (May 15, 2026). 44 standardized B2B use cases mapped to ERP billing processes." },
  { name: "Germany", region: "Europe", status: "Partially Live", effectiveDate: "Jan 2025", mandateType: "B2B + B2G", model: "Post-Audit", format: "XRechnung / ZUGFeRD 2.5", platform: "Peppol / GEBA", penalties: "Rejection of non-compliant B2G invoices", summary: "B2B reception mandatory since Jan 2025; issuance mandatory from Jan 2027 for businesses >€800K turnover. Published GEBA framework Mar 2026. ZUGFeRD 2.5 released May 20, 2026 — introduces native gross invoice support (book trade, publishing, petroleum) and alignment with latest EN 16931 code lists. BMF March 23, 2026 FAQ update: all e-invoices must be self-contained — any referenced supporting documents must be physically embedded in the invoice file. From Jan 2027, e-invoices delivered by email must be in valid structured XML format (XRechnung or ZUGFeRD) — email delivery of PDF-only or non-XML hybrid formats will not be compliant for B2B issuance. Credit notes must also be structured e-invoices with XML references to original invoice." },
  { name: "Greece", region: "Europe", status: "Live", effectiveDate: "2020", mandateType: "B2B + B2G", model: "Clearance", format: "myDATA XML", platform: "myDATA / AADE", penalties: "50% of VAT amount for VATable transactions; €500–€1,000 for non-VAT transactions; Phase 1 penalties active from May 3, 2026", summary: "Mandatory real-time reporting via myDATA since 2020. Mandatory B2B e-invoicing for large taxpayers (>€1M revenue) live since Mar 2, 2026; transition period ended May 3, 2026 — penalties now actively enforced for Phase 1. All other taxpayers must comply by Oct 1, 2026 (transition through Dec 31, 2026). Compliance via private EDIPs or free government tools (timologio, myDATAapp). myDATA e-Delivery (e-transport) Phase B delayed: control data activation October 12, 2026; TARIC-aligned commodity coding from January 1, 2027." },
  ...
  { name: "Slovakia", region: "Europe", status: "Upcoming", effectiveDate: "Jan 2027", mandateType: "B2B + B2G", model: "Clearance", format: "XML (UBL 2.1 / CII) EN 16931", platform: "IS EFA / Peppol", penalties: "Up to €100,000 for non-compliance", summary: "Parliament approved mandatory B2B e-invoicing law (Dec 2025). Voluntary live from May 1, 2026 — XML invoices exchanged via IS EFA/Peppol are now valid tax documents. Mandatory domestic B2B/B2G from Jan 1, 2027 via 5-corner Peppol model with certified 'Digital Postmen' service providers. XML structured invoices (EN 16931) required; simplified invoices <€100 exempt. Financial Administration launched interactive e-invoicing guide (May 5–6, 2026) and issued further guidance on non-VAT payer rules, EDI usage, archiving, and incorrect invoices (May 7, 2026). Conference for businesses scheduled Bratislava May 26, 2026. Cross-border (intra-EU) reporting obligations by Jun 30, 2030. Also from May 1, 2026: all eKasa-registered sellers must offer cashless payment for transactions over €1 (fines €500–€15,000 for non-compliance)." },
  ...
  { name: "Turkey", region: "Europe", status: "Live", effectiveDate: "2014", mandateType: "B2B + B2G + B2C", model: "Clearance", format: "UBL-TR", platform: "GIB (e-Fatura / e-Arşiv)", penalties: "Tax penalties and fines for non-compliance", summary: "Comprehensive clearance model since 2014. e-Fatura for B2B, e-Arşiv for B2C. Updated e-invoice package and VAT code controls effective Apr 1, 2026. Mandatory e-Beyan system for VAT returns expanded to additional provinces from May 2026. From May 2026, next-generation payment devices (OKC NG) must have built-in e-document integration capability — new POS/payment terminals must generate and transmit e-documents (e-receipt, e-archive invoice) directly from the device without separate software." },
  ...
  // ── Middle East ──
  { name: "Qatar", region: "Middle East", status: "Upcoming", effectiveDate: "Jan 2027 (expected)", mandateType: "B2B + B2G + B2C", model: "Clearance (B2B/B2G) + Reporting (B2C)", format: "TBD (FATOORA-like expected)", platform: "TBD — Ministry of Finance / General Tax Authority", penalties: "TBD", summary: "Cabinet approved draft e-invoicing law and implementing regulations on May 6, 2026, developed by the Ministry of Finance and General Tax Authority. Objective: establish a clear legal framework for electronic documents, improve transparency, and build regulatory databases. Expected model closely mirrors Saudi Arabia's FATOORA — clearance for B2B/B2G, reporting for B2C. Phased implementation likely from Jan 1, 2027. No confirmed timeline, technical specifications, or VAT regime alignment announced yet. Businesses advised to begin system impact evaluation." },
  ...
  { name: "UAE", region: "Middle East", status: "Partially Live", effectiveDate: "Jan 2027", mandateType: "B2B + B2G", model: "Clearance", format: "PINT-AE (UBL 2.1 XML)", platform: "FTA EmaraTax / Accredited Service Providers (Peppol)", penalties: "Up to AED 50,000; administrative penalties reduced by FTA effective Apr 14, 2026", summary: "Voluntary 4-corner Peppol e-invoicing model launched Apr 21–May 1, 2026 via EmaraTax. 5-corner model (Corner 5 tax reporting to FTA) going live ahead of the mandatory pilot on Jul 1, 2026. FTA extended the ASP appointment deadline for large businesses to October 30, 2026 (May 2026) — the Jan 1, 2027 mandatory go-live for large businesses (≥AED 50M) is unchanged; this is not a mandate delay but additional time to select a provider carefully. <AED 50M businesses mandatory from Jul 1, 2027; Government entities Oct 1, 2027. 24-month grace period for intra-VAT group transactions (exempt until Jan 2029). B2C and simplified invoices <AED 10K excluded. FTA reduced several administrative tax penalties effective Apr 14, 2026. 50+ mandatory data elements; 14-day transmission deadline; records must be stored in UAE." },
  ...
  { name: "Sri Lanka", region: "Asia-Pacific", status: "Partially Live", effectiveDate: "May 2026", mandateType: "B2B + B2G", model: "Clearance", format: "XML (Web API / RAMIS)", platform: "IRD RAMIS Platform", penalties: "TBD", summary: "National e-Invoicing System launched under 2026 Budget. Phase 1 (export-oriented VAT-registered businesses — garment and tea exporters) live from May 1, 2026 via Web API integration with IRD's RAMIS platform. Tea brokers already integrated; all relevant invoice, credit, and debit note records for tea auction transactions transmitted to RAMIS from May 1. New mandatory VAT invoice format takes effect July 2026. Phase 2 (all VAT-registered persons) targeted for full rollout by end of 2026." },
  ...
  { name: "Dominican Republic", region: "Latin America", status: "Partially Live", effectiveDate: "Nov 2026 (Phase 3)", mandateType: "B2B + B2G + B2C", model: "Clearance", format: "XML (e-CF)", platform: "DGII (e-CF)", penalties: "Fines per DGII regulations; non-compliant invoices invalid for tax purposes; sanctions from Nov 15, 2026 for Phase 3 non-compliance", summary: "e-CF (Comprobante Fiscal Electrónico) mandatory under Law No. 32-23. Phase 1 (National Large Taxpayers, May 2024) and Phase 2 (Local Large + Medium Taxpayers, Nov 2025) fully live. Phase 3 deadline for small, micro, and unclassified taxpayers and state entities extended to November 15, 2026 (from May 15, 2026) — DGII granted automatic 6-month extension; no application required. Sanctions apply from Nov 15, 2026. DGII updated e-CF Technical Report v1.0 in 2026 with updated technical requirements." },
  ...
  { name: "Peru", region: "Latin America", status: "Live", effectiveDate: "2012", mandateType: "B2B + B2G + B2C", model: "Clearance", format: "UBL 2.1 XML", platform: "SUNAT (CPE)", penalties: "Fines and operational restrictions; extended SIRE penalty relief in effect through 2026", summary: "Mandatory CPE (Comprobante de Pago Electrónico) via SUNAT for all taxpayers. SUNAT is accelerating the e-invoicing rollout in 2026 to bring additional taxpayer categories into the CPE system, while simultaneously extending penalty-free relief under the SIRE (Sistema Integrado de Registros Electrónicos) electronic records framework to ease the digital transition for businesses." },
  ...
  { name: "Kenya", region: "Africa", status: "Partially Live", effectiveDate: "2024", mandateType: "B2B + B2G", model: "Clearance", format: "JSON / XML", platform: "KRA (eTIMS / iTax)", penalties: "Fines per KRA regulations; zero-rated VAT deductions denied if not linked to valid eTIMS invoice in iCMS", summary: "eTIMS (electronic Tax Invoice Management System) mandatory and expanding. From May 2026, KRA pre-fills VAT returns with validated import/export data from the Integrated Customs Management System (iCMS) — validated export values automatically appear in iTax VAT returns once export documents are issued by Customs. Exporters and clearing agents must capture exporter PIN and a valid eTIMS zero-rated invoice number in iCMS for accurate pre-filling. Applies to exports to Single Customs Territory, foreign countries, EPZs, and SEZs." },
  ...
  { name: "Namibia", region: "Africa", status: "Upcoming", effectiveDate: "2026–2029 (phased)", mandateType: "B2B + B2G", model: "Clearance", format: "TBD", platform: "NamRA ITAS", penalties: "TBD", summary: "Mandatory e-invoicing confirmed but delayed from single April 2026 launch to a phased three-year rollout (2026/27 to 2028/29). All VAT-registered businesses will be required to participate; deadlines will be based on taxpayer category. 2026/27 Budget VAT Act amendments include e-invoicing provisions for real-time clearance model integrated with NamRA's ITAS. Infrastructure development and stakeholder alignment underway. Specific enforcement dates and phase details pending official announcement." },
      ...
      {expanded && (
        <div style={{ padding: "12px 20px 20px" }}>
          ...
          <div style={{ marginTop: 10, fontSize: 11, color: "#94a3b8", textAlign: "right" }}>
            Showing {filtered.length} of {recentChanges.length} changes · Mar 2 – May 12, 2026
          </div>
        </div>
      )}
    </div>
